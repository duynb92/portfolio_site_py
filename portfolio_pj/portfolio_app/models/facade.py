    ...
    def getProjects():
        projects = [
            Project(
                ...
                skills="Linux | Jira Customization | Jira REST API | Confluence REST API",
                length="3 months",
                categories=[],
                links=[],
                screenshots=0),
            ...
            Project(
                ...
                filters="atlassian",
                description=
                "Perform migration client's self-hosted Jira & Confluence to Cloud, without any loss. The self-hosted Jira instance have 1000+ users and 120+ projects, Confluence have 160+ spaces with over 15GB of attachments.",
                client="",
